...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    if (isset($_GET['user_id']) && is_numeric($_GET['user_id'])) {
        ...
        try {
            ...
            $logger->log("Attempting to get notifications for user id: $userId");

            $notifications = $model->getNotificationsByUserID($userId);
            ...
            if ($notifications) {
                ...
                $logger->log("Notifications retrieved successfully: UserID: $userId");
            } else {
